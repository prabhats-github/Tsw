...
<!-- Mirrored from swigo.dexignzone.com/xhtml/contact-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 11:23:53 GMT -->
<head>
	
	<!-- Title -->
	<title>Contact Page | TSW - Empowering Your Food Business | Rantox Digital</title>
			...
			<div class="main-bar clearfix ">
				<div class="container clearfix">
					...
					<div class="logo-header mostion">
						<a href="index.html" ><img src="assets/images/tsw-logo.png"
								alt="/"></a>
					</div>
					...
					<div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
						<div class="logo-header">
							<a href="index.html" ><img src="assets/images/tsw-logo.png" alt="/"></a>
						</div>
						<ul class="nav navbar-nav navbar white">
							...
							<li>
								<a href="photo-gallery.html">Media</a>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 m-b30 m-sm-b50">
							...
							<div class="input-group input-line input-black">
								<input name="Customer-name" required type="text" class="form-control" placeholder="John Doe">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 m-b30 m-sm-b50">
							<label class="form-label text-primary">Your Email</label>
							<div class="input-group input-line input-black">
								<input name="Customer-email" required type="text" class="form-control" placeholder="info@example.com">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 m-b30 m-sm-b50">
							<label class="form-label text-primary">Your Number</label>
							<div class="input-group input-line input-black">
								<input name="Customer-phone" required type="text" class="form-control dz-number" placeholder="9876543210">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 m-b30 m-sm-b50">
							<label class="form-label text-primary">Members</label>
							<div class="input-group input-line input-black">
								<input name="Total-members" required type="text" class="form-control" placeholder="1 Person">
							</div>
						</div>
						<div class="col-sm-12 m-b40">
							<label class="form-label text-primary">Message</label>
							<div class="input-group input-line input-black">
								<textarea name="Customer-message" required class="form-control" placeholder="Hi, do you Have a moment to talk About !"></textarea>
							</div>
						</div>
			...
			<div class="footer-top">
			  <div class="row">
				...
				<div class="col-lg-5 col-md-6 col-6 text-md-start">
				  ...
				  <div class="footer-menu wow fadeInUp" data-wow-delay="0.4s">
					<ul>
					  ...
					  <li><a href="tsw-menu.html">Menu</a></li>
				...
				<div class="col-lg-7 col-md-6 col-6 text-md-end">
				  <h5 class="footer-title wow fadeInUp" data-wow-delay="0.2s">Follow Us</h5>
				  <div class="footer-menu wow fadeInUp d-flex justify-content-md-end gap-3 mt-3" data-wow-delay="0.4s">
					...
					<a href="https://youtube.com" target="_blank"><i class="fab fa-youtube fa-lg"></i></a>
					<a href="https://linkedin.com" target="_blank"><i class="fab fa-linkedin-in fa-lg"></i></a>
				  </div>
				</div>
			  </div>
			</div>
			...
			<div class="footer-bottom">
			  <div class="row">
				...
				<div class="col-xl-6 col-md-6 text-md-end">
				  <span class="copyright-text">Crafted With <span class="heart"></span> by 
					<a href="https://www.rantoxdigital.com/" target="_blank">Rantox Digital</a>
				  </span>
				</div>
			  </div>
			</div>
